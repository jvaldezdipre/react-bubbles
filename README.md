...
- [x] Explain what a token is used for. - tokens are used for authentication and able to acces private routed components

- [x] What steps can you take in your web apps to keep your data secure? - enforce strong password - encrypt log in pages - use webtokens

- [x] Describe how web servers work. - A web server processes incoming network requests over HTTP and several other related protocols.

- [x] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers. - the Read method using the get function to retrieve data
